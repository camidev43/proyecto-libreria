            ...
            <section className={estilos.seccion_hero}>
                <div className={estilos.columna_texto}>
                    ...
                    <p className={estilos.parrafo_principal}>
                        Esto no es una librería pública, es un <strong>demo/laboratorio</strong> para validar patrones
                        de UI: estados, accesibilidad, tema claro/oscuro y tokens de diseño.
                    </p>
