...
- Storybook para documentación
    ...
    argTypes: {
        variant: {
            ...
            table: { type: { summary: 'string' }, defaultValue: { summary: 'solid' }, category: 'Appearance' },
        },
        color: {
            control: 'select',
        ...
        fullWidth: {
            ...
            table: { type: { summary: 'boolean' }, defaultValue: { summary: 'false' }, category: 'Layout' },
        },
        isIconOnly: {
            control: 'boolean',
...
export const Accesible: Story = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                story: 'Cuando el botón es solo icono, proporciona `aria-label` para exponer un nombre accesible (por ejemplo, “Buscar”).',
            },
        },
    },
};
